// This is the minified MandarinSpot Api. It entirely belongs to MandarinSpot, not me. It is public and for use at mandarinspot.com/static/mandarinspot.min.js
// I have copied the minified code here because github pages is stubborn and cannot access the api over the web. 
// This was retreived April 13, 2020
...
"hidden";n.style.left="-1000px";n.style.top="-1000px";n.style.width="";A.h(d)};A.i(d);c=c?c:d.lastChild.nodeValue?d.lastChild.nodeValue:d.lastChild.lastChild.nodeValue;var b=B[c][0],f=B[c][1],e=B[c][2],g="";if(c!==e){for(var h=0;h<c.length;++h)g+=c[h]!==e[h]?e[h]:"-";g=" ["+g+"]"}e='<div id="mandarinspot-tip-hz" style="font-size:150%;"><x-mspot>'+c+g+"</x-mspot></div>";h=0;for(g=b.length;h<g;++h)var l=y?f[h].replace(/([^<])\//g,"$1 / "):"â€¢ "+f[h].replace(/([^<])\//g,"$1<br />â€¢ "),e=e+('<div id="mandarinspotspot-tip-py" style="font-weight:bold">'+
